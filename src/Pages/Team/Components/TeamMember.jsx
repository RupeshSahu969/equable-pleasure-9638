    ...
    <>
      <Box fontSize="14px" w="100%" color="#666666" >
        <HStack spacing="none" border="1px solid #c6d2d9" p="5px 10px" >
          <Box w="100%" p=" 5px 15px" >Akshay Puranik</Box>
          <Box borderLeft="1px solid #c6d2d9" w="100%" p=" 5px 15px" >akshay.social@gmail.com</Box>
          <Box borderLeft="1px solid #c6d2d9" w="100%" p=" 5px 15px" >
            <HStack fontSize="11.9px" spacing="none">
              <Box p="5px" w="56px" border="1px solid #c6d2d9" bg="#f2f6f8" h="50%" >180</Box>
        ...
        <ModalContent fontSize="14px" borderRadius="none" >
          ...
          <ModalBody pb={6}>
            ...
            <FormControl mt={4}>
              ...
              <Input w="50%" borderRadius="none" placeholder='0' />
            </FormControl>
          </ModalBody>
          ...
          <ModalFooter>
            ...
            <Button _hover={{ background: "#48b6e8" }} borderRadius="2px" color="white" bg='#5cc7f8' mr={3}>
              SAVE
            </Button>
          </ModalFooter>
        </ModalContent>
