    ...
    <div id={styles.whole}>
      ...
      <Stack mt={20}>
        ...
        <Text fontSize={"1.315rem"} textAlign={"center"} color={"#5A6B7B"}>
          Track productivity, attendance, and billable hours with a <br />{" "}
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          ...
          <Stack spacing={4}>
            ...
            <Stack spacing={3}>
              ...
              />
              <Feature text={"Activity"} smallText={"See who works on what."} />
              <Feature
                text={"Rates"}
      ...
      <Stack marginTop={"80px"}>
        <button onClick={() => navigate("/features")} id={styles.featureBtn}>
          SEE ALL FEATURES
        </button>
      </Stack>
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
            <Stack>
              <Image
                ...
                objectFit={"cover"}
              />
              <Text fontWeight={"bold"} color={"#3D4853"}>
                Desktop
              </Text>
      ...
      <Container maxW={"7xl"} zIndex={10} position={"relative"}>
        ...
        >
          <Box className={styles.smallBoxes}>
            ...
            <Heading fontWeight={"normal"} fontSize={"22px"} color={"#3D4853"}>
              Boost productivity
            </Heading>
          ...
          <Box className={styles.smallBoxes}>
            ...
            <Text marginTop={"10px"} color={"#78909C"} fontSize={"1rem"}>
              ...
              on what, and manage workload <br /> among teams.
            </Text>
            <Flex
              marginTop={"10px"}
              color={"#03A9F4"}
          ...
          <Box className={styles.smallBoxes}>
            ...
            <Text marginTop={"10px"} color={"#78909C"} fontSize={"1rem"}>
              Track time and analyze your company's <br /> efficiency across
              projects, clients, departments, <br /> and employees.
            </Text>
            <Flex
              marginTop={"10px"}
              color={"#03A9F4"}
      ...
      <Stack mb={"150px"}>
        ...
        <Text color={" #78909C"} fontSize={"12px"}>
          MORE USE CASES
        </Text>
        <Center>
          <Flex>
          ...
          <Container align={"center"} margin={"auto"} maxW={"4xl"} py={12}>
            ...
            >
              ...
              <Stack pl={10} textAlign={"left"} pt={20} spacing={1}>
                ...
                <Text fontSize={"36px"} fontWeight={"bold"} color={"#03A9F4"}>
                  FOREVER!
                </Text>
                <Box>
                  <Text>
                    <Icon color={"#03A9F4;"} as={GiCheckMark} />{" "}
                    <span style={{ color: "#5A6B7B", fontSize: "18px" }}>
                      Unlimited users
                    </span>
                  </Text>
                  <Text>
      ...
      <Box as={Container} maxW="7xl" mt={14} p={4}>
        <Stack mb={20}>
          ...
          <Heading fontWeight={"normal"} color={"#3D4853"} fontSize={"34px"}>
          ...
          >
            <Flex>
              ...
              <Box
                ...
                fontSize={"14px"}
              >
                <Box fontSize={"28px"} color={"#3D4853"}>
                  24/7
                </Box>
      ...
      <Center>
        <Stack>
          <button
            className={styles.imgBtn}
            style={{ width: "170px", marginBottom: "-1px" }}
          >
            Contact us
          </button>
          <Text color={"#78909C"} fontSize={"12px"}>
...
const Feature = ({ text, smallText }) => {
  return (
    <Stack gap={0} align={"flex-start"}>
      ...
      <Text color={"#78909C"} fontSize={"14px"}>
        {smallText}
      </Text>
    </Stack>
  );
